                ...
                <Card className="cardpostion mcqstyle">
                    <CardBody>
                        ...
                        <Row>
                            ...
                            >
                                1. &nbsp; l'ensemble des tâches en série qui conditionnent la durée totale
                            </Button>
                        </Row>
                        <br />
                    ...
                    <Row>
                        ...
                        <div style={{ width: "300px", right: "100px" }} >
                            <nav>
                                <Link to="/chapter2/concept24" style={{ "font-size": "25px", "font-family": "Times New Roman", color: "green" }}><img style={{ height: "40px", width: "100px" }} id="profile-img" src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/71/Arrow_east.svg/2560px-Arrow_east.svg.png" /></Link>
                            </nav>
                        </div>
                    </Row>
                </Card>
