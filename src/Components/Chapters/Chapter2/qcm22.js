                ...
                <Card className="cardpostion mcqstyle">
                    <CardBody>
                        <CardTitle className="textstyleheader">
                            <h2>Q2. La définition d'une tâche est ... :</h2>
                            <br />
                        </CardTitle>
                        <Row>
                            <Button
                            ...
                            >
                                1. &nbsp; Une intervention caractérisé par une durée propre ààà
                            </Button>
                        </Row>
                        <br />
                        <Row style={{ paddingTop: "5px" }}>
                            ...
                            >
                                2. &nbsp; la somme des temps alloués pour une période défini
                            </Button>
                        </Row>
                        <br />
                        <Row style={{ paddingTop: "5px" }}>
                            ...
                            >
                                3. &nbsp; une contrainte technique ou commerciale
                            </Button>
                        </Row>
                        <br />
                    ...
                    <Row>
                        ...
                        <div style={{ width: "300px", right: "100px" }} >
                            <nav>
                                <Link to="/chapter2/about23" style={{ "font-size": "25px", "font-family": "Times New Roman", color: "green" }}><img style={{ height: "40px", width: "100px" }} id="profile-img" src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/71/Arrow_east.svg/2560px-Arrow_east.svg.png" /></Link>
                            </nav>
                        </div>
                    </Row>
                </Card>
