        ...
        <Card className="cardpostion mcqstyle">
          <CardBody>
            <CardTitle className="textstyleheader">
              <h2>Q5. le degré d'un sommet est :</h2>
              <br />
            </CardTitle>
            <Row>
              <Button
              ...
              >
                1. le nombre des sommets suivants.
              </Button>
            </Row>
            <br />
            <Row style={{ paddingTop: "5px" }}>
              ...
              >
                2. le nombre des sommets précédents.
              </Button>
            </Row>
            <br />
            <Row style={{ paddingTop: "5px" }}>
              ...
              >
                3.  la somme des arcs incidents et sortant du sommet.
              </Button>
            </Row>
            <br />
            <Row style={{ paddingTop: "5px" }}>
          ...
          <Row>
            ...
            <div style={{ width: "300px", right: "100px" }} >
              <nav>
                <Link to="/chapter1/concept7" style={{ "font-size": "25px", "font-family": "Times New Roman", color: "green" }}><img style={{ height: "40px", width: "100px" }} id="profile-img" src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/71/Arrow_east.svg/2560px-Arrow_east.svg.png" /></Link>
              </nav>
            </div>
          </Row>
        </Card>
