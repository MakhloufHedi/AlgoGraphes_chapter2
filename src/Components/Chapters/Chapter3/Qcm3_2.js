...
class Qcm3_2 extends Component {
        ...
        <Card className="cardpostion mcqstyle">
          <CardBody>
            <CardTitle className="textstyleheader">
              <h2>Q2. lequel parmis ces suggestions peut être un probleme d'arbre de poids minimum :</h2>
              <br />
            </CardTitle>
            <Row>
              <Button
              ...
              >
                1. chercher le temps optimale pour terminer un projet.
              </Button>
            </Row>
            <br />
            <Row style={{ paddingTop: "5px" }}>
              ...
              >
                2.  trouver le deuxieme plus court chemin.
              </Button>
            </Row>
            <br />
            <Row style={{ paddingTop: "5px" }}>
              ...
              >
                3.  reduire le cout d'installation un projet en réseau de telecommunication.
              </Button>
            </Row>
            <br />
            <Row style={{ paddingTop: "5px" }}>
          ...
          <Row>
            ...
            <div style={{ width: "300px", right: "100px" }} >
              <nav>
                <Link to="/Concept3_3" style={{ "font-size": "25px", "font-family": "Times New Roman", color: "green" }}><img style={{ height: "40px", width: "100px" }} id="profile-img" src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/71/Arrow_east.svg/2560px-Arrow_east.svg.png" /></Link>
              </nav>
            </div>
          </Row>
        </Card>
